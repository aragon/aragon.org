...
var Section = function Section(_ref2) {
  ...
  if (visual) return React__default.createElement(
    'div',
    containerProps,
    content
  );
...
var Text = function Text(_ref5) {
  ...
  return React__default.createElement(StyledComp, _extends({}, props, {
    weight: weight,
    size: size,
    smallcaps: smallcaps,
    color: color,
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        'div',
        { className: 'logo' },
        React__default.createElement('img', { src: publicUrl + logo, width: '158', height: '50', alt: 'Aragon' })
      ),
      React__default.createElement(
        'div',
        { className: 'all-links' },
        !compact && React__default.createElement(
          'div',
          { className: 'menus' },
          React__default.createElement(
            'nav',
...
var emailFormDefault = function emailFormDefault() {
  return React__default.createElement(
    ...
    React__default.createElement(
      'p',
      { className: 'email' },
      React__default.createElement('input', { type: 'email', placeholder: 'Enter your email' })
    )
  );
};
    ...
    renderLink({
      ...
      children: React__default.createElement(
        ...
        React__default.createElement(
          BreakPoint,
          { to: 'medium' },
          React__default.createElement('img', { alt: 'Aragon', src: publicUrl + logoMinimal, height: 40 })
        ),
        React__default.createElement(
          BreakPoint,
          { from: 'medium', to: 'large' },
          React__default.createElement('img', { alt: 'Aragon', src: publicUrl + logoMinimal, height: 50 })
        ),
        React__default.createElement(
          BreakPoint,
          { from: 'large' },
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        'div',
        { className: 'menu' },
        React__default.createElement(Logo$1, { compact: Boolean(title), renderLink: renderMenuItemLink }),
        ...
        menuItems.length > 0 && React__default.createElement(
          ...
          React__default.createElement(
            BreakPoint,
            { to: 'medium' },
            React__default.createElement(MenuPanel, { items: menuItems, renderLink: renderMenuItemLink })
          ),
          React__default.createElement(
            BreakPoint,
            { from: 'medium' },
  ...
  createClass(AragonApp, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(
        StyledAragonApp,
        styledProps,
        React__default.createElement(BaseStyles$1, null),
        children
      );
    }
  }]);
...
exports.styledCss = css;
exports.styledKeyframes = keyframes;
exports.styledInjectGlobal = injectGlobal;
exports.styledThemeProvider = ThemeProvider;
exports.styledWithTheme = wrapWithTheme;
exports.styledServerStyleSheet = ServerStyleSheet;
exports.styledStyleSheetManager = StyleSheetManager;
