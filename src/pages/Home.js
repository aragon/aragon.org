...
import FightForFreedom from '../components/Home/FightForFreedom'
...
class Home extends React.Component {
  render() {
      ...
      $.confetti = new function() {
        ...
        function SetGlobals() {
            $('body').append('<canvas id="confettiCanvas" style="position:absolute;top:0;left:0;display:none;z-index:99;position:fixed;"></canvas>');
