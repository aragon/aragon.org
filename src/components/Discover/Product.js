...
const About = () => (
  <Section>
    <Container>
      ...
      <Card imageUrl={'Discover/assets/discover4'} title="Built-in transparency" content={mudule2Content}></Card>
      <LongCard background="" textAlign="left" title="A universe of apps" content={mudule3Content}></LongCard>
    </Container>
  </Section>
);
