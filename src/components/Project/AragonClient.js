            ...
            {(this.state.active == 0 || this.state.active == 1) && (
              <Entry>
                <Module>
                  ...
                  <h3>
                    Make the platform and core apps responsive so Aragon can
                    be used from mobile browsers such as Status or Cipher.
                  </h3>
                </Module>
              </Entry>
            )}
            ...
            {(this.state.active == 0 || this.state.active == 2) && (
              <Entry>
                <Module>
                  ...
                  <h1>Rewards App</h1>
                  <h3>
                    Allow organizations to distribute payments to token
                    holders based on the number of tokens earned in a specific
                    period (one-time reward) or based on total holdings
                    (dividend).
                  </h3>
                </Module>
              </Entry>
            ...
            {(this.state.active == 0 || this.state.active == 1) && (
              <Entry>
                <Module>
                  ...
                  <h1>Payroll app</h1>
                  <h3>
                    This app will allow organizations to manage on-chain
                    salary payments and for employees to request payments and
              ...
              <Entry>
                <Module>
                  ...
                  <h3>
                    ...
                    information about ongoing and past transactions as well as
                    a toast component for immediate feedback on users’
                    actions.
                  </h3>
                </Module>
              </Entry>
              ...
              <Entry>
                <Module>
                  ...
                  <h3>
                    ...
                    with Aragon or use Aragon tools for their governance
                    needs.
                  </h3>
                </Module>
              </Entry>
              ...
              <Entry>
                <Module>
                  ...
                  <h3>
                    ...
                    statement, values, code of conduct, and contact
                    information so it’s easily accessible to prospective and
              ...
              <Entry>
                <Module>
                  ...
                  <h3>
                    ...
                    profiles, mapping their address to a human readable name
                    that can be used to interact with apps within the
                    organization.
                  </h3>
                </Module>
              </Entry>
              ...
              <Entry>
                <Module>
                  ...
                  <h3>
                    ...
                    for reputation-based organizations, including the ability
                    to allocation non-transferable tokens in place of (or in
            ...
            {(this.state.active == 0 || this.state.active == 2) && (
              <Entry>
                <Module>
                  ...
                  <h3>
                    Allow for more tightly coupled forwarder interactions
                    where the forwarded call data can be leveraged and
                    modified within the Forwarder contract.
                  </h3>
                </Module>
              </Entry>
            )}
            ...
            {(this.state.active == 0 || this.state.active == 2) && (
              <Entry>
                <Module>
                  ...
                  <h3>
                    Enhance aragonAPI to support the development of apps with
                    a single front-end and multiple contracts, and for
                    contract data to be displayed across multiple user
                    interfaces without coupling at the contract level.
                  </h3>
                </Module>
              </Entry>
            )}
            {(this.state.active == 0 || this.state.active == 1) && (
              <Entry>
                <Module>
                  ...
                  <h3>
                    Build native mobile Aragon client so users can benefit
                    from device and OS specific capabilities.
                  </h3>
                </Module>
              </Entry>
            )}
            ...
            {(this.state.active == 0 || this.state.active == 2) && (
              <Entry>
                <Module>
                  ...
                  <h3>
                    Allow organizations to customize their branding by
                    offering at least three additional color palettes,
                    including the ability to change the background image so
                    it’s different than the Aragon eagle.
                  </h3>
                </Module>
              </Entry>
            )}
            {(this.state.active == 0 || this.state.active == 1) && (
              <Entry>
                <Module>
                  ...
                  <h3>
                    Provide app developers with different monetisation models
                    to create revenue from the apps they publish in the Aragon
                    App Center.
                  </h3>
                </Module>
              </Entry>
              ...
              <Entry>
                <Module>
                  ...
                  <h3>
                    ...
                    resources by setting time based permissions like
                    budgeting.
                  </h3>
                </Module>
              </Entry>
              ...
              <Entry>
                <Module>
                  ...
                  <h3>
                    ...
                    discussions within Aragon, and implement it one
                    application to showcase the feature, such as the Voting
                    app.
                  </h3>
                </Module>
              </Entry>
            ...
            {(this.state.active == 0 || this.state.active == 1) && (
              <Entry>
                <Module>
                  ...
                  <h3>
                    Provide an opt-in failsafe for organizations and
                    individual apps to safely freeze their state during times
                    of emergency.
                  </h3>
                </Module>
              </Entry>
            ...
            {(this.state.active == 0 || this.state.active == 1) && (
              <Entry>
                <Module>
                  ...
                  <h3>
                    Reduce time for developers to get up and running with
                    using the aragonSDK and add features they request to it.
                  </h3>
                </Module>
              </Entry>
            )}
