...
const AragonNetwork = () => (
  <Main>
    ...
    <div>
      ...
      <Emphasis>
        <p>
          The Aragon Network (AN) will be the first DAO whose goal is to act as
          a digital jurisdiction that makes it extremely easy and friendly for
      ...
      <Content>
        ...
        <p>
          The Aragon Network has its own token, ANT, which will be used to
          govern every single aspect of its functioning.
        </p>
      </Content>
    </div>
  </Main>
